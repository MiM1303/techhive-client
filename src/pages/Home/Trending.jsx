                    ...
                    <Carousel autoPlay="true" infiniteLoop="true" interval={2000} showThumbs={false} stopOnHover={true} className='lg:w-[840px] lg:h-[360px] md:mx-auto couponCarousel static'>
                                {
                                    coupons.map(coupon=><div key={coupon._id} className="relative text-blue-600" >
                                        ...
                                        <div className="absolute text-white text-center top-6 lg:top-20 right-20 lg:right-60 z-10 space-y-2 lg:space-y-10">
                                            <p className="text-lg lg:text-4xl font-semibold">Use Coupon Code</p>
                                            <p className="text-2xl lg:text-7xl  font-bold">{coupon.coupon_code}</p>
                                            <p className="text-base lg:text-2xl font-semibold">To Get <span className='font-bold text-xl'>${coupon.discount_amount}</span> off!</p>
                                            <p className="text-sm lg:text-xl font-semibold">Valid till {coupon.expiry_date}!!</p>
                                        </div>
                                    </div>
                                    )
                                }
