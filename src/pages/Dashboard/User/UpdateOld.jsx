...
const UpdateOld = () => {
    ...
    const onSubmit = (data, event) =>{
        ...
        // if image was Old, uploading it to imgbb
        if(updatedProductInfo.product_image[0] !== updatedProductInfo.product_image){
            const imageFile = { image: updatedProductInfo.product_image[0] }
        ...
        //     updatedProductInfo.product_image = imageURL;
        // }
        console.log('sending to server:',updatedProductInfo);
